            ...
            <a-row type="flex" align="middle">
              <a-col :span="3" class="nav-item">
                <NuxtLink to="/" class="active">
                  <i-mdi-compass-outline /> 发现</NuxtLink
                >
              </a-col>
              <a-col :span="3" class="nav-item">
            ...
            <a-row type="flex" justify="space-around">
              <a-col>
                <div v-if="!userInfo">
                  ...
                  <a-button @click="signUp" shape="round" ghost type="primary"
                    >注册</a-button
                  >
                </div>
                <a-dropdown v-else>
                  ...
                  <template #overlay>
                    <a-menu>
                      <a-menu-item>
                        <NuxtLink class="select-user" @click="navigateTo('/')"
                          ><i-ant-design-user-outlined /> 我的主页</NuxtLink
                        >
                      </a-menu-item>
                      <a-menu-item>
                        <NuxtLink class="select-user"
                          ><i-ep-collection-tag /> 收藏文章</NuxtLink
                        >
                      </a-menu-item>
                      <a-menu-item>
                        <NuxtLink to="/user/settings" class="select-user"
                          ><i-ep-setting /> 设置</NuxtLink
                        >
                      </a-menu-item>
                      <a-menu-item @click="logout">
                        <NuxtLink class="select-user"
                          ><i-ant-design-logout-outlined /> 退出</NuxtLink
                        >
                      </a-menu-item>
                    </a-menu>
                  </template>
